...
@model({settings: {"idInjection":false,"postgresql":{"schema":"public","table":"tipo_permiso"}}})
export class TipoPermiso extends Entity {
  @property({
    type: Number,
    required: true,
    scale: 0,
  ...
  @property({
    ...
    required: false,
    scale: 0,
    postgresql: {"columnName":"meses_vigencia","dataType":"integer","dataLength":null,"dataPrecision":null,"dataScale":0,"nullable":"YES"},
  })
