...
@model({settings: {"idInjection":false,"postgresql":{"schema":"public","table":"tipo_id_persona"}}})
export class TipoIdPersona extends Entity {
  @property({
    type: Number,
    required: true,
    scale: 0,
  ...
  constructor(data?: Partial<TipoIdPersona>) {
    super(data);
  }
}
