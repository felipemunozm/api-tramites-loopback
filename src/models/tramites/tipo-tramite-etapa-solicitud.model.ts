...
@model({settings: {"idInjection":false,"postgresql":{"schema":"public","table":"tipo_tramite_etapa_solicitud"}}})
export class TipoTramiteEtapaSolicitud extends Entity {
  @property({
    type: Number,
    required: true,
    scale: 0,
  ...
  constructor(data?: Partial<TipoTramiteEtapaSolicitud>) {
    super(data);
  }
}
