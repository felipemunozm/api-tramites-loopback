...
@model({ settings: { "idInjection": false, "postgresql": { "schema": "public", "table": "tramite" } } })
export class Tramite extends Entity {
  ...
  @property({
    ...
    required: false,
    scale: 0,
    postgresql: { "columnName": "analista_aprobacion_id", "dataType": "bigint", "dataLength": null, "dataPrecision": null, "dataScale": 0, "nullable": "YES" },
  })
  analistaAprobacionId?: Number;

  @property({
    type: Number,
    required: false,
    scale: 0,
    postgresql: { "columnName": "solicitud_id", "dataType": "bigint", "dataLength": null, "dataPrecision": null, "dataScale": 0, "nullable": "YES" },
  })
  solicitudId?: Number;
