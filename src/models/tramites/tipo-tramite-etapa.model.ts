...
@model({settings: {"idInjection":false,"postgresql":{"schema":"public","table":"tipo_tramite_etapa"}}})
export class TipoTramiteEtapa extends Entity {
  @property({
    type: Number,
    required: true,
    scale: 0,
  ...
  constructor(data?: Partial<TipoTramiteEtapa>) {
    super(data);
  }
}
