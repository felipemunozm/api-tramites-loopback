...
@model({settings: {"idInjection":false,"postgresql":{"schema":"public","table":"solicitante_tramite"}}})
export class SolicitanteTramite extends Entity {
  @property({
    type: Number,
    required: true,
    scale: 0,
  ...
  @property({
    ...
    required: true,
    length: 255,
    postgresql: {"columnName":"relacion_sujeto","dataType":"character varying","dataLength":255,"dataPrecision":null,"dataScale":null,"nullable":"NO"},
  })
  relacionSujeto: String;
  ...
  constructor(data?: Partial<SolicitanteTramite>) {
    super(data);
  }
}
