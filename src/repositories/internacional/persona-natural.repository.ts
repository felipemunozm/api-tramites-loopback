...
export class PersonaNaturalRepository extends DefaultCrudRepository<
  ...
  public actualizarDireccionNaturalByRut(codigo_region: any, codigo_comuna: any, tipo: any, texto: any, persona_id: any, telefono_fijo: any, telefono_movil: any, persona_juridica_id: any): Promise<any> {
    ...
    return this.dataSource.execute(query, [codigo_region, codigo_comuna, tipo, texto, persona_id, telefono_fijo, telefono_movil, persona_juridica_id]);
  }
  ...
  public crearDireccionPersonaNatural(direccion: any, persona_juridica_id: any): Promise<any> {
    ...
    return this.dataSource.execute(query, [direccion.codigo_region, direccion.codigo_comuna, direccion.tipo, direccion.texto, direccion.persona_id, direccion.telefono_fijo, direccion.telefono_movil, persona_juridica_id]);
  }
