...
export class EmpresaRepository extends DefaultCrudRepository<
  ...
  public obtenerEmpresaByRut(rut: any): Promise<any> {
    let query: string = "select a.id, pj.id as persona_juridica_id, pj.identificador, pj.razon_social, pj.nombre_fantasia, te.nombre as tipo_empresa, te.codigo as codigo_empresa,\n" +
      "pj.tramite, de.codigo_comuna, co.nombre as nombre_comuna, de.codigo_region, re.nombre as nombre_region, de.texto, de.telefono_fijo, de.telefono_movil, de.email,\n" +
